...
const Proyects = function () {
  return (
    <div className="max-w-[1200px] p-5" id="projects">
      <div className="pb-8">
        <p className="mb-3 text-5xl text-white font-bold ">Projects</p>
        <p className="text-gray-400 my-1 ">
          This are my most relevant individual proyects
        </p>
      </div>

      <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 px-10 ">
        <div
        ...
        >
          ...
          <div className=" opacity-0 group-hover:opacity-90 bg-[gray]/70 absolute inset-0 flex flex-col justify-center items-center">
            <div className="pt-8 text-center">
              <a href="https://youtu.be/Sh5yTLnBQtg" target="blank">
                <button className="text-center rounded-lg px-4 py-3 m-2 bg-black text-white font-bold text-lg">
                  Newspaper app is, like the name say's, a newspaper provided by
                  the "Current's" API. This app only uses Expo Go.{<br />}
                  {
